...
import {searchSanPhamtheoLoaiSerVice, TimKiemSanPham} from "../../../services/sanphamService"

class SanPhamTimKiem extends Component {
    constructor(props)
    {
        super(props);
        this.state = {
   ...
   async componentDidMount()
    {
       ...
       let mangTemp = await TimKiemSanPham(this.props.match.params.key)
    ...
    render() {
        console.log("check sate.sanphamSearch", this.state.sanphamSearch)
        let sanphamArr = this.state.sanphamSearch
        let ma_loaisp = this.state.ma_loaisp
        let loai = this.props.loaispArr
        console.log("check sanphamArr", sanphamArr)
        console.log("check tên 1111111111111111111111 ", this.props.match.params.key)
        return (
            <>
                <HomeHeader/>   
                <br/>
                ...
                <div className='left-right'>
                    <div className='title'>TẤT CẢ SẢN PHẨM TÌM KIẾM</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(SanPhamTimKiem);
